...
**AI disclosure.** Built with AI assistance from **Claude** (Anthropic), **Kimi K3**, **GLM**, **Grok**, and **DeepSeek** — across implementation, the data pipeline, copy drafting, visual design, and fact-checking. All under my creative direction.
