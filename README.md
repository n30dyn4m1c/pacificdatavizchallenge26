...
- **NOAA CPC weekly Niño 3.4 index, week centred 19 August 2026 (+2.6 °C)** — one quoted reading (refreshed from CPC's published weekly table on 31 August 2026), drawn as a ringed marker, never joined to the monthly line (a different product on a different SST basis: OISST, against the monthly series' ERSST).
...
**AI disclosure.** Built with AI assistance from **Claude** (Anthropic), **Grok**, and **DeepSeek** — across implementation, the data pipeline, copy drafting, visual design, and fact-checking. All under author's creative direction.
